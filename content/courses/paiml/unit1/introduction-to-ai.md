...
A computer passes the Turing Test if a human interrogator cannot distinguish the machine from a human after questioning both. Required capabilities:
...
Understanding how humans think and modeling it in computers. Uses introspection, psychological experiments, and brain imaging.

**3. Thinking Rationally (Laws of Thought)**
Using logic to reason correctly. Aristotle's syllogisms were early examples:
- All men are mortal
- Socrates is a man
